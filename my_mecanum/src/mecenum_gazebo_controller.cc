...
#include <iostream>
#include <my_mecanum/agv_position.h>
...
namespace gazebo
{
  class Mecanum : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      pose_pub = mRosnode->advertise<my_mecanum::agv_position>("mecanum_position", 1000);
      ...
      public: void UpdateChild(const common::UpdateInfo & /*_info*/)
      {
        ...
        mecanum_pos.position_x  = pose.Pos().X();
        mecanum_pos.position_y  = pose.Pos().Y();
        mecanum_pos.position_th = pose.Rot().Yaw();
        
        joint_states_.header.stamp = current_time;
        last_time = current_time;
        joint_pub.publish(joint_states_);
        pose_pub.publish(mecanum_pos);
        }
      ...
      private:
        ...
        my_mecanum::agv_position mecanum_pos;
