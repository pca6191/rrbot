...
void mecanum_position(const my_mecanum::agv_position::ConstPtr& msg)
{
...
int main(int argc, char** argv) {
    // Node initialization
    ros::init(argc, argv, "mecanum_odom_controller");
    ros::NodeHandle n;
    ...
    ros::Subscriber mecanum_pos = n.subscribe("/mecanum_position", 1000, &mecanum_position);
